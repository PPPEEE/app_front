...
export default payScreen = createMaterialTopTabNavigator({  
  wantBuy: {
    ...
    navigationOptions: {
      tabBarLabel: '我要买',
      tabBarIcon: ({ tintColor }) => <MIcons name="cart" size={22} color={tintColor} />,
    },
  },
  wantSell: {
    screen: wantSell,
    navigationOptions: {
      tabBarLabel: '我要卖',
      tabBarIcon: ({ tintColor }) => <MIcons name="cart-outline" size={22} color={tintColor} />,
    },
  },
  wantEntrust: {
    screen: wantEntrust,
  ...
  tradeScreen: {
    ...
    navigationOptions: {
      tabBarLabel: '订单',
      tabBarIcon: ({ tintColor }) => <MIcons name="file-document-box-outline" size={22} color={tintColor} />,
